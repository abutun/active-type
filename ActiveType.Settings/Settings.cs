...
namespace ActiveType.Settings
{
    ...
    public class Settings : ICollection, ICloneable
    {
        ...
        public void LoadDefaultSettings()
        {
            ...
            this.Add(Constants.propLanguage);

            // default language of the keyboarlayout
            this.Add(Constants.propKeyboardLayout);

            // default setting for the sounds. is it allowed or not ?
            this.Add(Constants.propPlaySounds);

            // default setting for course content lenght
            this.Add(Constants.propCourseContentLength);
        }
